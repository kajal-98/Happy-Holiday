<%@ Page Title="" Language="C#" MasterPageFile="~/master/user.master" AutoEventWireup="true" CodeFile="spviewdetails.aspx.cs" Inherits="user_spviewdetails" %>
        ...
        <tr><td>
                ...
                ForeColor="#333333">
                    ...
                    <ItemTemplate><table class="style2">
                            ...
                            <tr><td style="border: thin solid #000099" width="200">Type :</td>
                                <td style="border: thin solid #000099" width="500"><asp:Label ID="Label1"  Text='<%#Eval("type") %>' runat="server"></asp:Label></td></tr>
