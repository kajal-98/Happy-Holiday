<%@ Page Title="" Language="C#" MasterPageFile="~/master/user.master" AutoEventWireup="true" CodeFile="fviewdetails.aspx.cs" Inherits="user_fviewdetails" %>
                ...
                ForeColor="#333333">
                    ...
                    <ItemTemplate><table class="style2">
                            ...
                            <tr><td colspan="2" style="border: thin solid #000099"><asp:Label ID="name" 
                                    Text='<%# Eval("packname") %>' runat="server" Font-Bold="True" 
                                    Font-Size="XX-Large" ForeColor="#FF0066"></asp:Label></td></tr>
                            ...
                            <tr><td style="border: thin solid #000099" width="200">&nbsp;</td>
                                <td style="border: thin solid #000099" width="500">&nbsp;</td></tr>
                            <tr><td colspan="2" style="border: thin solid #000099">
                                <asp:Button ID="Button1" runat="server" CssClass="but" onclick="Button1_Click" 
                                    Text="Book" Width="200px" />
                                </td>
                                </tr>
                        </table></ItemTemplate>
